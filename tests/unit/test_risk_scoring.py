...
class TestRiskScorer:
    ...
    def test_deep_dependencies_increase_risk(self) -> None:
        task_data = {
            "feature": "deep",
            "tasks": [
                {"id": "T1", "title": "L1", "level": 1, "dependencies": [],
                 "files": {"create": ["a.py"], "modify": [], "read": []},
                 "verification": {"command": "true"}, "estimate_minutes": 5},
                {"id": "T2", "title": "L2", "level": 2, "dependencies": ["T1"],
                 "files": {"create": ["b.py"], "modify": [], "read": []},
                 "verification": {"command": "true"}, "estimate_minutes": 5},
                {"id": "T3", "title": "L3", "level": 3, "dependencies": ["T2"],
                 "files": {"create": ["c.py"], "modify": [], "read": []},
                 "verification": {"command": "true"}, "estimate_minutes": 5},
                {"id": "T4", "title": "L4", "level": 4, "dependencies": ["T3"],
                 "files": {"create": ["d.py"], "modify": [], "read": []},
                 "verification": {"command": "true"}, "estimate_minutes": 5},
                {"id": "T5", "title": "L5", "level": 5, "dependencies": ["T4"],
