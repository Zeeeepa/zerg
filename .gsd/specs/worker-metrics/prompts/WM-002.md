...
## Overview
Create new `zerg/metrics.py` module with MetricsCollector class and helper functions.
...
```python
"""Metrics computation and aggregation for ZERG."""
...
```bash
python -c "from zerg.metrics import MetricsCollector, duration_ms, calculate_percentile; print('MetricsCollector OK')"
```

## Acceptance Criteria
- [ ] zerg/metrics.py module exists
