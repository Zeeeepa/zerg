"""Tests for ZERG v2 Estimate Command."""
...
class TestTaskAnalysis:
    ...
    def test_analysis_creation(self):
        ...
        analysis = TaskAnalysis(
            total_tasks=20, levels=4, critical_path_length=6, max_parallelization=5
        )
    ...
    def test_analysis_to_dict(self):
        ...
        analysis = TaskAnalysis(
            total_tasks=10, levels=3, critical_path_length=3, max_parallelization=4
        )
...
class TestEstimateResult:
    ...
    def test_result_creation(self):
        ...
        resources = ResourceEstimate(
            optimal_workers=5, estimated_tokens=100000, api_cost=1.50
        )
    ...
    def test_result_to_markdown(self):
        ...
        analysis = TaskAnalysis(
            total_tasks=5, levels=2, critical_path_length=2, max_parallelization=3
        )
        resources = ResourceEstimate(
            optimal_workers=3, estimated_tokens=50000, api_cost=0.75
        )
...
class TestTimeEstimator:
    ...
    def test_estimate_returns_multiple_confidences(self):
        ...
        estimator = TimeEstimator()
        analysis = TaskAnalysis(
            total_tasks=10, levels=3, critical_path_length=3, max_parallelization=5
        )
